...
if __name__ == '__main__':
	...
	while True:
		...
		# command to open any application of our system :
			...
			codePath = r"C:\\Users\\vaibhavi\AppData\\Local\\Programs\\youtube-music-desktop-app\\YouTube Music Desktop App.exe"
			os.startfile(codePath)
		elif 'vs code' in query:
			codePath = r"C:\\Users\\vaibhavi\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
			os.startfile(codePath)
		...
		elif 'email to vaibhavi' in query:
			try:
				speak("What should I say?")
				content = takeCommand()
				to = "vaibhu930@gmail.com"
				sendEmail(to, content)
				speak("Email has been sent !")
			except Exception as e:
				print(e)
		...
		# command for communication with voice assistant :
			...
			speak("I have been created by vaibhavi.")	
		...
		# frequently asked questions with voice assistant :
			...
			speak("Thanks to vaibhavi. further It's a secret")
		elif 'power point presentation' in query:
			speak("opening Power Point presentation")
			power = r"C:\\Users\\vaibhavi\\Desktop\\Minor Project\\Presentation\\Voice Assistant.pptx"
			os.startfile(power)
		elif 'is love' in query:
			speak("It is 7th sense that destroy all other senses")
		elif "who are you" in query:
			speak("I am your virtual assistant created by vaibhavi")
		elif 'reason for you' in query:
			speak("I was created as a Minor project by Mister vaibhavi ")

		# changing background of screen and lockscreen :
		elif 'change background' in query:
			ctypes.windll.user32.SystemParametersInfoW(20,0,"C:\\Users\\vaibhavi\\OneDrive\\Pictures\\pubg.png",0)
			speak("Background changed successfully")
		elif 'lock screen' in query:
			os.system('reg add HKLM\SOFTWARE\Policies\Microsoft\Windows\Personalization /v LockScreenImage /t REG_SZ /d "{}" /f'.format("C:\\Users\\vaibhavi\\OneDrive\\Desktop\\gh.png"))
			speak("Background changed successfully")
